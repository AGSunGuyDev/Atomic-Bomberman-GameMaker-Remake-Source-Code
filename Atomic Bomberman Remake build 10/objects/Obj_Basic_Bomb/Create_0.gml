...
Z_curve = animcurve_get_channel(Anim_C_Bomb_Arc_Flight, "curve1")
Z_Axis = 0;
Z_position = 0;
Z_int_percentage = 0;
floorZ = 0;
...
Tile_skip_count = 3 * sprite_width //<--older value: 3.45 * sprite_width, new value: 3.324
...
tile_instance_x = 0;
//target_x = x + tile_instance_x; <--instance based
