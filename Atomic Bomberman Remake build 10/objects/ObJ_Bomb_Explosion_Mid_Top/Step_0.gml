...
switch(state){
	case explosion_state.explosion_fade_in:
		if (end_flame_sprite = true) && (connect_up = false){
			sprite_index = Spr_Far_Top_Flame_fade_in;
		}
		else if (end_flame_sprite = false) && (connect_up = false){
			sprite_index = Spr_Mid_Top_Flame_fade_in;
		}
	...
	case explosion_state.explosion_idle:
		if (end_flame_sprite = true) && (connect_up = false){
			...
			sprite_index = Spr_Mid_Top_Flame;
		}
		else if (connect_up = true){
	...
	case explosion_state.explosion_fade_out:
		...
		if (end_flame_sprite = true) && (connect_up = false){
			...
			sprite_index = Spr_Mid_Top_Flame_fade_out;
		}
		else if (connect_up = true){
